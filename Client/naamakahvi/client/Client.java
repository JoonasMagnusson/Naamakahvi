...
public class Client 
{
    ...
    /*
      Konstruktori ainoastaan tallentaa hostin nimen ja portin, joita se käyttää myöhemmissä metodikutsuissaan, jotka muodostavat aina uuden HTTP-yhteyden.
     */
        ...
        throws Exception
    {
        ...
        ub.setScheme("http").setHost(this.host).setPath("/register")
            .setParameter("username", username)
            .setParameter("imagedata", imagedata.toString());
        URI uri = ub.build();
    ...
    public static void main(String[] args)
    {
        try {
            ...
            c.registerUser("veikko nieminen", null);
        } catch (Exception e) {
